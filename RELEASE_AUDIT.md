...
|---|---|
| Godot 2D/3D literary game | project.godot/main.tscn, real Node3D candlelit stage in atmosphere.gd; illustrated card interface in main.gd; graphical smoke rendered successfully |
...
| Multiple public-domain authors | card_data.gd defines Poe, Shelley, Shakespeare, Austen, Carroll, Conan Doyle, and Rice Burroughs, five units each and unique author powers; Bierce provides two supplemental cards |
| Neutral literary cards and learning | 22 neutral concepts and two Bierce supplemental concepts, including imagery, metaphor, foreshadowing, expose, and reprieve; 59 cards with lessons/source references; 50 literary questions; correct answers reward ink/insights |
| Swift tactical mechanics and AI | Three lanes, persistent damage, simultaneous retaliation, author powers, concepts, fatigue; 392 seeded matches finish 3–10 chapters, median 5; 13,715 rules assertions pass |
| Complete single-player loop | Title, selection, campaign, quick duel, deck editor, catalogue, tutorial, quiz, pause/log, result and repeat navigation implemented; 90 UI lifecycle checks pass |
...
| Playtesting and error checks | Rules 13,715/0, action snapshots 28/0, UI 90/0, profile 12/0; source mouse test and independent packaged mouse test pass; packaged test 28 clicks/five chapters/zero failures, clean exit |
